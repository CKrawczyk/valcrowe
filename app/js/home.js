...
const Home = () => (
  <Row>
    <Col xs={12}>
      ...
      <p>
        We are making an anonymised version of this survey dataset available for public use [add link to full dataset].  If you use or refer to this data in any way,
